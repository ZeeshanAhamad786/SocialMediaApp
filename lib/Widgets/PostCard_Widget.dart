          ...
          children: [
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => Profile(
                            userId: createPostController.postsList.first.userId,
                            postId: createPostController.postsList.first.postId,
                            otherUserProfile: !widget.ispersonalpost,
                            profileImage: createPostController
                                .postsList.first.userProfileImage,
                            profileName: createPostController
                                .postsList.first.username
                                .toString()), // Replace SecondScreen with the screen you want to navigate to.
                      ),
                    );
                  },
                  child: ProfilePicWidget(
                      picType: 'network',
                      createPostController.postsList.first.userProfileImage,
                      45,
                      45),
                ),
                  ...
                  children: [
                    Text(
                      createPostController.postsList.isNotEmpty
                          ? createPostController.postsList.first.username
                              .toString()
                    ...
                    Text(
                      createPostController.postsList.isNotEmpty
                          ? createPostController.postsList.first.timestamp
                              .toString()
                          : 'No timestamp available',
                    ...
                    image: DecorationImage(
                      image: createPostController.postsList.isNotEmpty &&
                              createPostController
                                  .postsList.first.userPostImage.isNotEmpty
                          ? NetworkImage(createPostController
                              .postsList.first.userPostImage)
            ...
            Text(
              createPostController.postsList.first.description.isNotEmpty
                  ? createPostController.postsList.first.description
                  : "No Description",
            ...
            Wrap(
              children: widget.post.hashtags
                  .map((hashtag) => Text(
                        '#$hashtag ',
                        style: const TextStyle(
                            color: Color(0xff7F7F7F), fontSize: 13),
                      ))
                  .toList(),
            ),
